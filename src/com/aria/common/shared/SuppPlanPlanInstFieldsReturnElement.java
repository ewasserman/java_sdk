...
@XmlType(name = "supp_plan_plan_inst_fields_ReturnElement", propOrder = {"planInstanceFieldName", "planInstanceFieldValue"})
public class SuppPlanPlanInstFieldsReturnElement {
