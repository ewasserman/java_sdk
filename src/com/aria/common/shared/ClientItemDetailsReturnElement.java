...
@XmlType(name = "client_item_details_ReturnElement", propOrder = {"itemNo", "itemLabel", "serviceNo", "serviceDesc", "clientSku", "itemPlan", "itemMonths", "currencyCd", "classNo", "classLabel", "stockLevel", "avgRatings", "numRatings", "numReviews", "imageUrl", "imageText", "clientItemId", "clientServiceId", "clientItemPlanId", "purchaseScope"})
public class ClientItemDetailsReturnElement {
