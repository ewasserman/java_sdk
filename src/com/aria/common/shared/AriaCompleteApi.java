...
@WebServiceClient(name = "aria_complete_api",
                  ...
                  targetNamespace = "urn:client:api:wsdl:document/literal_wrapped:vers:6.40:aria_complete_api")
public class AriaCompleteApi extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("urn:client:api:wsdl:document/literal_wrapped:vers:6.40:aria_complete_api", "aria_complete_api");
    public final static QName CompletePort = new QName("urn:client:api:wsdl:document/literal_wrapped:vers:6.40:aria_complete_api", "completePort");
    static {
