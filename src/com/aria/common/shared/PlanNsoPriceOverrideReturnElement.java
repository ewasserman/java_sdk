...
@XmlType(name = "plan_nso_price_override_ReturnElement", propOrder = {"rateScheduleNo", "clientRateScheduleId", "currencyCd", "overridePrice"})
public class PlanNsoPriceOverrideReturnElement {
