...
@XmlType(name = "plan_unit_inst_service_details_ReturnElement", propOrder = {"serviceNo", "clientServiceId", "serviceName", "fulfillmentStatus", "fulfillmentDate"})
public class PlanUnitInstServiceDetailsReturnElement {
