...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "writeoffDetail"})
@XmlRootElement(name = "get_writeoff_details_mResponseElement")
public class GetWriteoffDetailsMResponseElement {
