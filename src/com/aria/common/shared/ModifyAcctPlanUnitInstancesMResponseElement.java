...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "prorationResultAmount", "collectionErrorCode", "collectionErrorMsg", "statementErrorCode", "statementErrorMsg", "procCvvResponse", "procAvsResponse", "procCavvResponse", "procStatusCode", "procStatusText", "procPaymentId", "procAuthCode", "procMerchComments", "cancelledSuppPlans", "invoiceNo", "expectdActivationFee", "expectdMthlyRecurringCost", "expectdAnnuRecurringCost", "invoiceLineItem", "totalChargesBeforeTax", "totalTaxCharges", "totalChargesAfterTax", "totalCredit", "totalTaxCredit", "totalCreditBeforeTax", "total", "prorationCreditResultAmount", "prorationCreditAmount", "prorationTaxAmount"})
@XmlRootElement(name = "modify_acct_plan_unit_instances_mResponseElement")
public class ModifyAcctPlanUnitInstancesMResponseElement {
    ...
    protected List<InvoiceLineItemReturnElement> invoiceLineItem;
    ...
    public List<InvoiceLineItemReturnElement> getInvoiceLineItem() {
        if (this.invoiceLineItem == null) {
            this.invoiceLineItem = new ArrayList<InvoiceLineItemReturnElement>();
        }
