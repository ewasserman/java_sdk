...
public class PlanInstanceDetailsReturnElement {
    ...
    protected List<BackupPaymentMethodInfoReturnElement> backupPaymentMethodInfo;
    ...
    public List<PrimaryPaymentMethodReturnElement> getPrimaryPaymentMethod() {
        ...
        return this.primaryPaymentMethodInfo;
    }public List<BackupPaymentMethodInfoReturnElement> getBackupPaymentMethodInfo() {
        if (this.backupPaymentMethodInfo == null) {
            this.backupPaymentMethodInfo = new ArrayList<BackupPaymentMethodInfoReturnElement>();
        }
        return this.backupPaymentMethodInfo;
    }
}
