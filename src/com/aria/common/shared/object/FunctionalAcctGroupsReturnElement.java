...
@XmlType(name = "functional_acct_groups_ReturnElement", propOrder = {"functionalAcctGroupNo", "clientFunctionalAcctGroupId"})
public class FunctionalAcctGroupsReturnElement {
