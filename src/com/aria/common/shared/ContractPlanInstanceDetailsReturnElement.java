...
@XmlType(name = "contract_plan_instance_details_ReturnElement", propOrder = {"planInstanceNo", "planName", "clientPlanInstanceId", "planInstanceStatusCd", "planInstanceStatusLabel", "rolloverPlanNo", "rolloverClientPlanId", "rolloverRateSchedNo", "rolloverClientRateSchedId", "contractRolloverCustomRateInfo"})
public class ContractPlanInstanceDetailsReturnElement {
