...
@XmlType(name = "invoice_line_item_ReturnElement", propOrder = {"lineNo", "lineType", "serviceNo", "serviceName", "lineUnits", "ratePerUnit", "lineAmount", "lineBaseUnits", "prorationFactor", "description", "dateRangeStart", "dateRangeEnd", "creditCouponCode", "planNo", "planName", "clientServiceId", "clientPlanId"})
public class InvoiceLineItemReturnElement {
