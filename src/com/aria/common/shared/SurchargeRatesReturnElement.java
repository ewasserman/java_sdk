...
@XmlType(name = "surcharge_rates_ReturnElement", propOrder = {"rateSeqNo", "fromUnit", "toUnit", "ratePerUnit", "includeZero", "rateSchedIsAssignedInd", "rateTierDescription"})
public class SurchargeRatesReturnElement {
