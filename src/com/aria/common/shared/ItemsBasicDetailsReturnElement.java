...
@XmlType(name = "items_basic_details_ReturnElement", propOrder = {"itemNo", "itemLabel", "serviceNo", "serviceDesc", "clientSku", "itemPlan", "itemMonths", "stockLevel", "avgRatings", "numRatings", "numReviews", "itemType", "itemDesc", "activeInd", "modifyPriceInd", "subunitQty", "subunitLabel", "serviceType", "coaId", "clientCoaCode", "taxableInd", "taxGroup", "usageType", "clientItemId", "clientServiceId", "clientItemPlanId", "usageTypeCd", "purchaseScope"})
public class ItemsBasicDetailsReturnElement {
