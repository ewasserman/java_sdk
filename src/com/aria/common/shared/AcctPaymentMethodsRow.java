...
@XmlType(name = "acct_payment_methods_row", propOrder = {
    "paymentMethodName",
...
public class AcctPaymentMethodsRow {

    @XmlElement(name = "payment_method_name")
    protected String paymentMethodName;
    @XmlElement(name = "client_payment_method_id")
    protected String clientPaymentMethodId;
    @XmlElement(name = "payment_method_description")
    ...
    protected Long paymentMethodType;
    ...
    public void setPaymentMethodType(Long value) {
