...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "planUnitInstNo",    "clientPlanUnitInstId",    "newClientPlanUnitInstId",    "planUnitInstServices",    "planUnitInstFields",    "doWrite"})
@XmlRootElement(name = "update_acct_plan_unit_instance")
public class UpdateAcctPlanUnitInstance {
    ...
    protected PlanUnitInstServicesArray planUnitInstServices;
    ...
    public void setNewClientPlanUnitInstId(String value) {
        this.newClientPlanUnitInstId = value;
            ...
            public PlanUnitInstServicesArray getPlanUnitInstServices() {
        return planUnitInstServices;
    }

    public void setPlanUnitInstServices(PlanUnitInstServicesArray value) {
        this.planUnitInstServices = value;
    }
