...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId",    "altStmtTemplateNo",    "autoSkipToNextBillDate"})
@XmlRootElement(name = "get_acct_preview_statement_m")
public class GetAcctPreviewStatementM {
