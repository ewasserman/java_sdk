...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "couponCode",    "acctNo",    "clientAcctId",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId"})
@XmlRootElement(name = "apply_coupon_to_acct_m")
public class ApplyCouponToAcctM {
