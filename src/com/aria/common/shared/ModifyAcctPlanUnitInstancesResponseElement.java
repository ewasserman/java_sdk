...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "prorationResultAmount", "invoiceNo", "suppPlanLineItems", "totalChargesBeforeTax", "totalTaxCharges", "totalChargesAfterTax", "totalCredit", "totalTaxCredit", "totalCreditBeforeTax", "total", "prorationCreditResultAmount", "prorationCreditAmount", "prorationTaxAmount", "expectdActivationFee", "expectdMthlyRecurringCost", "expectdAnnuRecurringCost", "thirdPartyErrors"})
@XmlRootElement(name = "modify_acct_plan_unit_instancesResponseElement")
public class ModifyAcctPlanUnitInstancesResponseElement {
