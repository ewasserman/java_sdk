...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "creditAmount",    "creditReasonCode",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId",    "comments"})
@XmlRootElement(name = "apply_service_credit_m")
public class ApplyServiceCreditM {
