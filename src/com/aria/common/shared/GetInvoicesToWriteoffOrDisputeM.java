...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId"})
@XmlRootElement(name = "get_invoices_to_writeoff_or_dispute_m")
public class GetInvoicesToWriteoffOrDisputeM {
