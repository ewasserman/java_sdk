...
public class AllAcctPlansMReturnElement {
    ...
    @XmlElement(name = "plan_instance_fields_detail")
    protected List<PlanInstanceFieldsDetailReturnElement> planInstanceFieldsDetail;
    ...
    }public List<PlanInstanceFieldsDetailReturnElement> getPlanInstanceFieldsDetail() {
        if (this.planInstanceFieldsDetail == null) {
            this.planInstanceFieldsDetail = new ArrayList<PlanInstanceFieldsDetailReturnElement>();
        }
        return this.planInstanceFieldsDetail;
    ...
    }public List<SurchargesAllReturnElement> getSurchargesAll() {
        if (this.surchargesAll == null) {
