...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "transactionId",    "acctNo",    "clientAcctId",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId"})
@XmlRootElement(name = "get_inv_no_from_bal_xfer_m")
public class GetInvNoFromBalXferM {
