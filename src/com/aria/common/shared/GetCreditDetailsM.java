...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "creditNo",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId",    "localeNo",    "localeName"})
@XmlRootElement(name = "get_credit_details_m")
public class GetCreditDetailsM {
