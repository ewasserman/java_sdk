...
@XmlType(name = "all_client_item_details_ReturnElement", propOrder = {"itemNo", "itemLabel", "serviceNo", "serviceDesc", "clientItemId", "clientServiceId", "clientItemPlanId", "usageTypeCd", "allServiceSuppFields", "clientSku", "itemPlan", "itemMonths", "stockLevel", "avgRatings", "numRatings", "numReviews", "itemType", "itemDesc", "activeInd", "modifyPriceInd", "subunitQty", "subunitLabel", "serviceType", "coaId", "clientCoaCode", "taxableInd", "taxGroup", "usageType", "purchaseScope", "allItemPrices", "allItemImages", "allItemSuppFields", "allItemClasses"})
public class AllClientItemDetailsReturnElement {
