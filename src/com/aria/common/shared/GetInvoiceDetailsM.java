...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "invoiceNo",    "acctNo",    "clientAcctId",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId",    "localeNo",    "localeName"})
@XmlRootElement(name = "get_invoice_details_m")
public class GetInvoiceDetailsM {
