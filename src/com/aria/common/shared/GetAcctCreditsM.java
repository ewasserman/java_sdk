...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "masterPlanInstanceNo",    "clientMasterPlanInstanceId",    "limitRecords"})
@XmlRootElement(name = "get_acct_credits_m")
public class GetAcctCreditsM {
