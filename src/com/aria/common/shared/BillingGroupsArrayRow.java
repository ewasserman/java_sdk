...
@XmlType(name = "billing_groups_array_row", propOrder = {
    "billingGroupName",
...
public class BillingGroupsArrayRow {
    ...
    @XmlElement(name = "bg_notify_method")
    protected Long bgNotifyMethod;
    ...
    public Long getBgNotifyMethod() {
        return bgNotifyMethod;
    }

    public void setBgNotifyMethod(Long value) {
        this.bgNotifyMethod = value;
    }
