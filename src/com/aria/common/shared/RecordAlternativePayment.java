...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey",    "acctNo",    "clientAcctId",    "referenceCode",    "paymentAmount",    "processorId",    "payMethod",    "statementNo",    "comments",    "clientReceiptId",    "allowRecurring"})
@XmlRootElement(name = "record_alternative_payment")
public class RecordAlternativePayment {
